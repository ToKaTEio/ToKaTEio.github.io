...
<br>
I have been playing the guitar since high school, and it has become a part of me. It helps me express myself and eases my worries.<br> <br>

I have also been the guitarist in several bands, where I met many good friends. Over the past six years, I have performed on stage more than ten times. Here is a picture of me and my band members.
...
<br>
For my performance, see my [performance](/file/performance) blog for more details. 

## Music
Music has always been one of the most important parts of my life. To me, it is one of humanity’s oldest and greatest art forms, something that speaks directly to the heart.
<br>
<br>
...
<div style="display: flex; justify-content: center; gap: 70px; align-items: flex-start;">
  <div style="width: 23%; text-align: center;">
    ...
    <p style="font-size: 14px; color: gray;"><strong>幼さを入院させて</strong> <br>from <strong>神聖かまってちゃん</strong> my favourite rock band</p>
  </div>

  <div style="width: 23%; text-align: center;">
    <img src="/images/music/kc.jpg" style="width: 100%; height: auto;" />
    <p style="font-size: 14px; color: gray;"><strong>Larks' Tongues in Aspic</strong> <br>Greatest progressice rock album in my opinion</p>
  </div>

  <div style="width: 23%; text-align: center;">
    <img src="/images/music/orangestar.jpg" style="width: 100%; height: auto;" />
    <p style="font-size: 14px; color: gray;"><strong>未完成エイトビーツ</strong> <br>from <strong>Orangestar</strong> my memories of youth</p>
  </div>
</div>
