...
I am currently taking this course in 2026 Spring term taught by Prof. Shi PU. I am still learning, but here is [my cheat sheet](/file/notes/MAT3220CP1.pdf) for the midterm, covering material from mathematical preliminaries, unconstrained optimization, and optimization over convex sets.

### MAT3280 Probability Theory 概率论
I took this course in 2024 Fall term, taught by Prof. Wingki Shum (Kenneth). Along with MAT2050, it was another excellent course I took at CUHK-Shenzhen. Prof. Shum also wrote his own textbook, [Measure-theoretic Probability: With Applications to Statistics, Finance, and Engineering](https://link.springer.com/book/10.1007/978-3-031-49830-5).<br>

In the first half of the term, the course provided a rigorous introduction to measure-theoretic probability, closely connected with MAT3006 Real Analysis. It began with topology, sigma-algebras, measures and measurable functions, and continued through the Borel–Cantelli lemma, the Lebesgue integral, Fatou’s lemma, and the Dominated Convergence Theorem.

In the second half, the course covered a broad but still substantial range of topics in probability, including coupling and optimal transport, moment-generating functions and characteristic functions, different modes of convergence, the law of large numbers, and conditional expectation. There were also lectures briefly introducing more advanced ideas from stochastic processes like martingales, and from functional analysis like Hilbert spaces.
...
<div style="display: flex; justify-content: space-between;">
  ...
  <img src="file\preview\mat3280\MAT3280preview2.png" style="width: 27%;">
  <img src="file\preview\mat3280\MAT3280preview3.png" style="width: 27%;">
</div>
<br>
